...
public class MSG {
    ...
    @XmlElementRef(name = "appVersion", namespace = "http://schemas.datacontract.org/2004/07/WcfServiceLibrary", type = JAXBElement.class)
    protected JAXBElement<String> appVersion;
    @XmlElementRef(name = "data", namespace = "http://schemas.datacontract.org/2004/07/WcfServiceLibrary", type = JAXBElement.class)
    protected JAXBElement<ArrayOfanyType> data;
    @XmlElementRef(name = "info", namespace = "http://schemas.datacontract.org/2004/07/WcfServiceLibrary", type = JAXBElement.class)
    protected JAXBElement<String> info;
    @XmlElementRef(name = "operationName", namespace = "http://schemas.datacontract.org/2004/07/WcfServiceLibrary", type = JAXBElement.class)
    protected JAXBElement<String> operationName;
    @XmlElementRef(name = "operationVersion", namespace = "http://schemas.datacontract.org/2004/07/WcfServiceLibrary", type = JAXBElement.class)
    protected JAXBElement<String> operationVersion;
    protected Boolean statutOp;
    @XmlElementRef(name = "tokenApp", namespace = "http://schemas.datacontract.org/2004/07/WcfServiceLibrary", type = JAXBElement.class)
    protected JAXBElement<String> tokenApp;
    @XmlElementRef(name = "tokenUser", namespace = "http://schemas.datacontract.org/2004/07/WcfServiceLibrary", type = JAXBElement.class)
